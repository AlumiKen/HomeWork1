namespace homework1.Models
{
	public static class RepositoryHelper
	{
		...
		public static CustomerListInfoViewRepository GetCustomerListInfoViewRepository()
		{
			var repository = new CustomerListInfoViewRepository();
			repository.UnitOfWork = GetUnitOfWork();
			return repository;
		}

		public static CustomerListInfoViewRepository GetCustomerListInfoViewRepository(IUnitOfWork unitOfWork)
		{
			var repository = new CustomerListInfoViewRepository();
